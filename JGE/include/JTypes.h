...
typedef enum Buttons
  {
    ...
    JGE_BTN_VERIFY,    // Mark the selected card verified 100% correct (PC test aid)
    JGE_BTN_PARTIAL,   // Mark the selected card as mostly-works / partial (PC test aid)

    JGE_BTN_MAX = JGE_BTN_PARTIAL + 1
  } JButton;
