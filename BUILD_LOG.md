...
2026-05-25 0ca6c9c55 (wagic-v146-windows)  device=RP5     result=install-pass — ndk-build clean (6 pre-existing Boost warnings), patched APK via patch_apk.py (ant debug fails on Java 25: NoClassDefFoundError sun/misc/BASE64Encoder), adb install -r succeeded, core.zip pushed as Wagic-core-0256.zip (APK macro WAGIC_RESOURCE_MINOR still =6, NOT 7 — pushed 0257 by mistake first, removed); gameplay verification pending; S9 not connected
2026-05-25 0ca6c9c55 (wagic-v146-windows)  device=RP5     result=images-pass — pushed 11 missing User/sets dirs from G:\Wagic-windows\User\sets (EOC EOE EOS FCA FIC FIN GN3 SPM TLA TMT UNF, 163 MB total). "primitives" subdir skipped (scratch only, baked into core.zip). User had images disabled in-app — file system was already at parity for everything else.
2026-05-25 0ca6c9c55 (wagic-v146-windows)  device=S9      result=install-pass — adb install -r succeeded, core.zip pushed as Wagic-core-0256.zip to SD UUID 0449-B4A1.
2026-05-25 0ca6c9c55 (wagic-v146-windows)  device=S9      result=images-pass — bulk push of User/sets completed; paused at ~150/349 after ~17 GB, resumed via `push_sets_to_device.ps1` which size-checked and skipped matching sets, then pushed remaining 185 sets (20.3 GB in 14:11, all 0 failures). Final state: all 349 sets (10E–ZVE) on device at /storage/0449-B4A1/.../User/sets/.
2026-05-25 0ca6c9c55 (wagic-v146-windows)  device=S9      result=profile-pass — pushed Maxglee profile (collection.dat 1.1 MB + 31 decks deck1-32 sans deck25, options.txt, replacement_map.json, etc.) from G:\Wagic-windows\User\profiles\Maxglee\ to /storage/0449-B4A1/.../User/profiles/Maxglee/ (39 files total).
```
